...
public class Y2020D18PuzzleTest {
    ...
    public void part1a_sample_validationTest() {
        Assert.assertEquals(-1, (int) new Y2020D18Puzzle(Arrays.asList(sample1)).solution1());
    }

    @Test
    public void part1_actual_validationTest() {
        Assert.assertEquals(-1, (int) new Y2020D18Puzzle().solution1());
    }

    @Test
    public void part2a_sample_validationTest() {
        Assert.assertEquals(-1, (int) new Y2020D18Puzzle(Arrays.asList(sample1)).solution2());
    }

    @Test
    public void part2_actual_validationTest() {
        Assert.assertEquals(-1, (int) new Y2020D18Puzzle().solution2());
    }
